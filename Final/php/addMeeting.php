<?php	
	...
	*********************/
	...
	//	addMeeting.php
	//		This page handles a request to add a new meeting to the database
	//		Note: it should not be loaded directly, but via an ajax request from main.php
	
	//This function validates the input that came with the request
	...
	if (validateInput($name, $day, $time, $address, $town, $isOpen, $lat, $lng)){
		...
		mysql_close($con);
		echo "<h3 class='styled'>Success!</h3>";
	}
	else{
		echo "<h3 class='styled'>Failure...</h3>";
	}
?>
<table>
